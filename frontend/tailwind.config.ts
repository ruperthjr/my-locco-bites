  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        display: ['Bakery Display', 'system-ui', 'sans-serif'],
        script: ['Handwritten Script', 'cursive'],
      },
      animation: {
      ...
      backgroundImage: {
        ...
        'wood': "url('@/assets/images/backgrounds/texture-wood.jpg')",
        'marble': "url('@/assets/images/backgrounds/texture-marble.jpg')",
      },
      boxShadow: {
